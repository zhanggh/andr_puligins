package com.plugin.barcode.scanner;
...
import com.plugin.R;
import com.plugin.barcode.camera.CameraManager;
import com.plugin.barcode.decode.CaptureActivityHandler;
import com.plugin.barcode.decode.FinishListener;
import com.plugin.barcode.decode.InactivityTimer;
import com.plugin.barcode.view.ViewfinderView;
import com.plugin.commons.AppException;
import com.plugin.commons.ComApp;
import com.plugin.commons.helper.ComUtil;
import com.plugin.commons.helper.DialogUtil;
import com.plugin.commons.model.Barcode;
...
//		initSetting();
		...
		ComUtil.customeTitle(this, "扫一扫",true);
		initView();
	}
...
//	}
	...
	private void displayFrameworkBugMessageAndExit() {
		...
		builder.setMessage(getString(R.string.zh_msg_camera_framework_bug));
...
//						UIHelper.showLoginDialog(CaptureActivity.this);
						DialogUtil.showToast(CaptureActivity.this,"尚未登陆");
						return;
					}
				}
				switch (type) {
...
//					signin(barcode);
				...
				DialogUtil.showToast(this, "json数据解析异常");
				mProgress.dismiss();
			}
		}
	}
		...
		new AlertDialog.Builder(CaptureActivity.this)
				...
				.setPositiveButton("复制", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						...
						// 将文本数据复制到剪贴板
						cm.setText(msg);
						DialogUtil.showToast(CaptureActivity.this, "复制成功");
					}
				})
