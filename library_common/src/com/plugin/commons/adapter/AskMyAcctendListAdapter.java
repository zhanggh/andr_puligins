...
public class AskMyAcctendListAdapter extends BaseAdapter {
	
	private Context context;
	private List<AskMsgModel> dataList;
	private static Map<String,View> viewMap = new HashMap<String,View>();
	
	public AskMyAcctendListAdapter(Context context, List<AskMsgModel> data){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowView.findViewById(R.id.ll_commentcount).setVisibility(View.GONE);
        return rowView;
	}
