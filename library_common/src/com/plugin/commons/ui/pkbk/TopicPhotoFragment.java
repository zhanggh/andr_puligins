...
public class TopicPhotoFragment extends BaseFragment {
	public DingLog log = new DingLog(TopicPhotoFragment.class);
	private static final String TAG = "TopicPhotoFragment";
	...
	private TopicPhotListAdapter mAdapter;
	NewsService newsSvc;
...
//		}
	...
	private void refreshList(){
		...
		if(mAdapter==null){
			mAdapter = new TopicPhotListAdapter(mActivity,dataList);
	...
	public void onResume() {
		super.onResume();
		AnalyticsAgent.onPageStart(getActivity(), "TopicPhotoFragment");
	}
	...
	public void onPause() {
		...
		super.onPause();
		AnalyticsAgent.onPageEnd(getActivity(), "TopicPhotoFragment");
	}
