...
public class VideoSurfacePlayer extends Activity implements OnCompletionListener,OnErrorListener,OnInfoListener,   
	...
	public void onCreate(Bundle savedInstanceState){   
	    ...
	    url =(String)getIntent().getExtras().get(CoreContants.PARAMS_MSG);
	    ...
	    try {   
	        player.setDataSource(VideoSurfacePlayer.this, Uri.parse(dataPath));   
